...
class VOCSegDataset(torch.utils.data.Dataset):
    def __init__(self, is_train, crop_size, voc_dir):
        self.transform = torchvision.transforms.Normalize([0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])
    ...
    def __getitem__(self, index):
        feature, label = voc_rand_crop(self.features[index], selflabels[index], *self.crop_size)
